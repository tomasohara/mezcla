...
# class TestUseStandardEquivalentDecorator(TestWrapper):  
#     script_module = TestWrapper.get_testing_module_name(__file__, THE_MODULE)
    
#     @THE_MODULE.use_standard_equivalent
#     def rename_file(self, source, target):
#         return gh.rename_file(source, target)

#     @THE_MODULE.use_standard_equivalent
#     def delete_file(self, filename):
#         return gh.delete_file(filename)

#     def test_rename_file(self):
#         source = "/tmp/old_name.txt"
#         target = "/tmp/new_name.txt"
#         with patch('os.rename') as mock_rename:
#             self.rename_file(source, target)
#             mock_rename.assert_called_once_with(source, target)

#     def test_delete_file(self):
#         filename = "/tmp/file_to_delete.txt"
#         with patch('os.remove') as mock_remove:
#             self.delete_file(filename)
#             mock_remove.assert_called_once_with(filename)

# class TestUseMezclaEquivalentDecorator(TestWrapper):  
#     script_module = TestWrapper.get_testing_module_name(__file__, THE_MODULE)
    
#     @THE_MODULE.use_mezcla_equivalent
#     def rename_file(self, source, target):
