...
ENV PATH="/opt/hostedtoolcache/Python/${PYTHON_VERSION}/x64/bin:${PYTHONPATH}:$WORKDIR"
...
RUN python3 -m nltk.downloader -d /usr/local/share/nltk_data punkt averaged_perceptron_tagger stopwords
